    ...
    return (
        <section>
            ...
            <div className="row justify-content-center pt-5">
                <div className="col-xl-12 col-lg-12 text-center p-5">
                    <p className="Cormorant-Garamond">FOUNDED IN 1879</p>
                </div>
                <div className="col-lg-4 col-md-8 m-1 ">
                    <img src={imgFactory} alt="factory" className="w-100"></img>
                </div>
                <div className="col-lg-3 col-md-8 m-1 hero slang-text">
                    <h2><br />“Life should be slower and deeper rather than faster and cheaper”</h2>
                    <p>
