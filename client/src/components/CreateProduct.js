                    ...
                    <div className='row'>
                        <div className='col-lg-12 BoxShadow'>
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group pb-3">
                                    <label><h5>Image URL:</h5></label> <br />
                                    <span>E.g:  https://res.cloudinary.com/img-cloud-repo/image/upload/v1604479574/samples/ecommerce/other/sample_inqmk7.png</span> <br /><br />
                                    <input
                                        type="text"
                                        required
                                        className="form-control"
